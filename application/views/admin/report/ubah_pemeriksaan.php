...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form" action="<?=base_url('admin_side/perbarui_data_pemeriksaan');?>" method="post" enctype='multipart/form-data'>
                                    ...
                                    <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(data_upload/dokumentasi_pemeriksaan/'.$value->nama_file.')">
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="'.base_url().'admin_side/hapus_foto_pemeriksaan/'.md5($value->id_dokumentasi).'" class="btn btn-label-light-o2 btn-bold "><font color="red">Hapus</font></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

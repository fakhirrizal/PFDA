            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="dropdown dropdown-inline">
                        <button type="button" onclick="window.location.href='<?= base_url().'admin_side/pemeriksaan'; ?>'" class="btn btn-brand btn-icon-sm" >
            ...
            <script type="text/javascript" language="javascript" >
                $(document).ready(function(){
                    $('#tbl').dataTable({
                        ...
                        "bProcessing": true,
                        "ajax" : {
                            url:"<?= site_url('admin/Report/json_data_pemeriksaan'); ?>"
                        },
                        "aoColumns": [

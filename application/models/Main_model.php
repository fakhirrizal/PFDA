...
class Main_model extends CI_Model
{
	...
	public function get_nomor_pasien($nama)
	{
		$nomor_pasien = '';
		$year_code = date('y');
		...
		if($get_last_data==NULL){
			...
			$pecah_data = explode('.',$get_last_data->nomor_pasien);
			$get_new_id = $pecah_data[2]+1;
			$nomor_pasien = $first_char.'.'.$year_code.'.'.$get_new_id;
		}
		return $nomor_pasien;
	}
